    ...
    <div className={`card ${expandedView ? 'p-0' : 'p-4 lg:p-6'} ${expandedView ? '' : 'hover:-translate-y-1'}`}>
      <div className="flex gap-3 lg:gap-4">
        ...
        <div className="flex flex-col items-center gap-1 pt-1">
          ...
          >
            <FaArrowUp className="w-3 h-3 lg:w-4 lg:h-4" />
          </button>
          ...
          >
            <FaArrowDown className="w-3 h-3 lg:w-4 lg:h-4" />
          </button>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 lg:gap-4 mt-4 pt-3 border-t border-slate-100">
            ...
            >
              <FaRegCommentAlt className="w-3 h-3 lg:w-4 lg:h-4" />
              ...
              {user && (
                <form onSubmit={handleSubmitComment} className="space-y-3">
                  <textarea
                    ...
                    className="input resize-none text-sm lg:text-base"
                    rows={3}
                  />
                  <button
                    type="submit"
