    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="max-h-[60vh] overflow-y-auto">
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 m-6 flex items-center gap-3 text-red-700">
            ...
            {activeTab === 'steam' && (
              <div className="space-y-6">
                ...
                <form onSubmit={handleSteamConnect} className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Steam ID or Custom URL</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Profile URL</label>
                    <input
                      type="url"
            ...
            {activeTab === 'riot' && (
              <div className="space-y-6">
                ...
                <form onSubmit={handleRiotConnect} className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Game Name</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Tag Line</label>
                    <input
            ...
            {activeTab === 'epic' && (
              <div className="space-y-6">
                ...
                <form onSubmit={handleEpicConnect} className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Epic Games Display Name</label>
                    <input
            ...
            {activeTab === 'ubisoft' && (
              <div className="space-y-6">
                ...
                <form onSubmit={handleUbisoftConnect} className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-slate-700 mb-2">Ubisoft Username</label>
                    <input
